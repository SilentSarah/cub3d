...
/*   Updated: 2023/07/19 11:58:38 by hassimi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int32_t main(int32_t argc, const char* argv[])
{
	...
	map[0] = "    1111111111111111111111";
	map[1] = "11111000101000000000000001";
	map[2] = "10000000101000000000000001";
	map[3] = "10000000101000000000000001";
	map[4] = "10000001010000000000000001";
	map[5] = "10010000000000000000000001";
	map[6] = "10010001000001111111111111";
	map[7] = "10000000100010000000000001";
	map[8] = "10000000000000000000000001";
	map[9] = "11111111111111111111111111";
	map[10] = 0;
	pa = M_PI + M_PI_2;
	px = cos(pa) * 40;
	py = sin(pa) * 40;
	map_hight = (40 * 10) + 40;
	map_width = (40 * 27) + 40;
	if (!(mlx = mlx_init(640, 440, "MLX42", false)))
	{
